...
link:task_configure_gMSA_on_windows_server_2012_or_later.html["Microsoft Exchange Server 2012 以降でグループマネージドサービスアカウントを設定します"^]。
...
インストールパス
 a| 
デフォルトパスはです `C:\Program Files\NetApp\SnapCenter`。
