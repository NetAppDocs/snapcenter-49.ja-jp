...
+
ポリシーを作成するには、を選択しimage:../media/add_policy_from_resourcegroup.gif["リソースグループからポリシーを追加"]てポリシーウィザードを開始します。
...
.. 検証スケジュールを設定するポリシーを選択し、を選択しますimage:../media/add_policy_from_resourcegroup.gif["リソースグループからポリシーを追加"]。
