...
* DLLが破損している場合は、SnapCenterサーバのインストールを修復します。
* NSMが破損しているか構成ファイルが破損している場合は、同じバージョンのSnapCenterサーバをアンインストールして再インストールします。
* VMが破損している場合は、同じ名前の別のVMを起動し、同じバージョンのSnapCenterサーバをインストールします。
